...
export default {
  ...
  async created() {
    ...
    try {
      ...
      if (userData.Avatar) {
        this.user.avatar = `http://social-net.duckdns.org/uploads/${userData.Avatar}`;
      } else {
  ...
  methods: {
    async fetchAllowedUsers() {
      try {
        const res = await fetch("http://social-net.duckdns.org/api/postsprivacy", {
          method: "GET",
          credentials: "include",
        });
        if (res.ok) {
    ...
    async fetchAllUsers() {
      try {
        ...
        const allUsersRes = await fetch("http://social-net.duckdns.org/api/allusers", {
          method: "GET",
          credentials: "include",
        });
        if (allUsersRes.ok) {
        ...
        const chatUsersRes = await fetch("http://social-net.duckdns.org/api/openchat", {
          method: "GET",
          credentials: "include",
        });
        if (chatUsersRes.ok) {
    ...
    async fetchPosts() {
      try {
        const res = await fetch("http://social-net.duckdns.org/api/getposts", {
          method: "GET",
          credentials: "include",
        });
        if (res.ok) {
          ...
          this.posts = data.map((post) => ({
            ...
            authorAvatar: post.Avatar
              ? `http://social-net.duckdns.org/uploads/${post.Avatar}`
    ...
    async fetchComments(post) {
      try {
        const res = await fetch(
          `http://social-net.duckdns.org/api/getcomments?post_id=${post.Id}`,
          {
            method: "GET",
            credentials: "include",
          }
        ...
        if (res.ok) {
          ...
          post.comments = data.map((comment) => ({
            ...
            image: comment.image ? `http://social-net.duckdns.org/uploads/${comment.image}` : null,
          }));
    ...
    async addComment(post) {
      ...
      try {
        const res = await fetch("http://social-net.duckdns.org/api/addcomments", {
          method: "POST",
          credentials: "include",
          body: formData
        });
    ...
    async submitPost() {
      ...
      try {
        ...
        const res = await fetch("http://social-net.duckdns.org/api/posts", {
          method: "POST",
          credentials: "include",
          body: formData
        });
    ...
    async toggleJoin(group) {
      try {
        ...
        if (group.member_status === 'accepted') {
          endpoint = "http://social-net.duckdns.org/api/removememberfromgroup";
          action = "leave";
          requestBody = {
            group_id: group.id,
            user_id: userData.id  
          ...
          endpoint = "http://social-net.duckdns.org/api/cancelgrouprequest";
          action = "cancel request from";
          requestBody = {
            group_id: group.id
          };
        } else if (group.member_status === 'invited') {
          endpoint = "http://social-net.duckdns.org/api/acceptgroupinvite";
          ...
          endpoint = "http://social-net.duckdns.org/api/requesttojoingroup";
          action = "join";
          requestBody = {
            group_id: group.id
          };
    ...
    async fetchMessages(user) {
      ...
      try {
        const res = await fetch(
          `http://social-net.duckdns.org/api/getmessages?sender=${this.user.username}&receiver=${user}`,
          {
            method: "GET",
            credentials: "include",
          }
    ...
    async fetchGroups() {
      try {
        const response = await fetch("http://social-net.duckdns.org/api/getgroups", {
          method: "GET",
          credentials: "include",
        });
    ...
    async checkGroupMembership(groupId) {
      try {
        ...
        const response = await fetch(
          `http://social-net.duckdns.org/api/ismember?group_id=${groupId}`,
          {
            method: "GET",
            credentials: "include",
          }
    ...
    async createGroup() {
      try {
        ...
        const response = await fetch("http://social-net.duckdns.org/api/creategroups", {
          method: "POST",
          credentials: "include",
          headers: {
            "Content-Type": "application/json",
    ...
    async fetchPostsPrv() {
      try {
        const res = await fetch("http://social-net.duckdns.org/api/postsprv", {
          method: "GET",
          credentials: "include",
        });
        if (res.ok) {
