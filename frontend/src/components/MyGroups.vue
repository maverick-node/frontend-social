...
export default {
  ...
  methods: {
    ...
    async fetchMyGroups() {
      try {
        const response = await fetch('https://5512-20-56-138-63.ngrok-free.app/api/mygroups', {
          credentials: 'include'
        });
        if (response.ok) {
    ...
    async fetchPendingInvitations(groupId) {
      try {
        const response = await fetch(`https://5512-20-56-138-63.ngrok-free.app/api/GetInvitations?group_id=${groupId}`, {
          credentials: 'include'
        });
        if (response.ok) {
    ...
    async leaveGroup(groupId) {
      try {
        ...
        const response = await fetch("https://5512-20-56-138-63.ngrok-free.app/api/removememberfromgroup", {
          method: "POST",
          credentials: "include",
          headers: {
            "Content-Type": "application/json",
