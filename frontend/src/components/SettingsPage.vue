...
export default {
  ...
  methods: {
    async updatePrivacy() {
      try {
        const res = await fetch(`https://5512-20-56-138-63.ngrok-free.app/api/updateprivacy`, {
          method: 'POST',
          credentials: 'include',
          body: JSON.stringify({
    ...
    async fetchInvitations() {
      try {
        const res = await fetch(`https://5512-20-56-138-63.ngrok-free.app/api/getinvitationsfollow`, {
          method: 'GET',
          credentials: 'include'
        });
    ...
    async acceptInvitation(invitationId) {
      try {
        const res = await fetch(`https://5512-20-56-138-63.ngrok-free.app/api/accepteinvi`, {
          method: 'POST',
          credentials: 'include',
          body: JSON.stringify({
    ...
    async rejectInvitation(invitationId) {
      try {
        const res = await fetch(`https://5512-20-56-138-63.ngrok-free.app/api/followers?action=rejectInvitation&profileUser=${invitationId}`, {
          method: 'POST',
          credentials: 'include'
        });
        if (res.ok) {
    ...
    async checkprivacy() {
      const res = await fetch("https://5512-20-56-138-63.ngrok-free.app/api/checkmyprivacy", {
        credentials: 'include',
      })
      const data = await res.json()
